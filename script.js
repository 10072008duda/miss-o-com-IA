...
]let atual = 0;let perguntaAtual;function mostraPergunta() {
    perguntaAtual = perguntas[atual];
}function mostraPergunta() {
    perguntaAtual = perguntas[atual];
    caixaPerguntas.textContent = perguntaAtual.enunciado;
}mostraPergunta()const perguntas = [
  {
    enunciado:
...
let perguntaAtual;function mostraPergunta() {
  perguntaAtual = perguntas[atual];
  caixaPerguntas.textContent = perguntaAtual.enunciado;
}mostraPergunta();
const perguntas = [
...
mostraPergunta();const alternativa(const alternativa of perguntaAtual.alternativas)function mostraAlternativas() {
  for (const alternativa of perguntaAtual.alternativas) {
  }
}function mostraAlternativas() {
  for (const alternativa of perguntaAtual.alternativas) {
...
]missao-inteligencia-artificialconst caixaPrincipal = document.querySelector(".caixa-principal");
...
console.log(dadoD6());function dadoD6() {
    var numero = Math.floor(Math.random() * 6) + 1;
    return numero;
}

console.log(dadoD6());i atrás de vídeos, artigos e mais informaçõe sobre como utilizar essa tecnologia.",
        ],
      },
    ],
  },
